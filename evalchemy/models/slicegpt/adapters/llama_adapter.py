...
from transformers import PreTrainedModel, DynamicCache, Cache, set_seed
...
class CompressedLlamaDecoderLayer(LlamaDecoderLayer):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # if use_cache: # present_key_value 随着 transformers 升级被舍弃
...
class LlamaModelAdapter(ModelAdapter):
    ...
    def _from_pretrained(
        ...
        *,
        ...
        if not (model_name.startswith("meta-llama/Llama-2") or model_name.startswith("meta-llama/Meta-Llama-3") or model_name.startswith("allenai/Llama-3.1-Tulu-3-8B-SFT")):
            return None
