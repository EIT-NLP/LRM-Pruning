...
# pip install -e eval/chat_benchmarks/MTBench -i https://pypi.tuna.tsinghua.edu.cn/simple

# Log into HuggingFace for datasets and models.
huggingface-cli login
```
deepspeed main.py \          
--model_path /model/plclmezboss/Llama31-8B-instruct-full/Llama31-8B-instuct-fullsft-openthoughts \
--lora \
--method original \
--dataset_path datasets/UltraInteract_sft_with_messages \
--warmup_ratio 0.1 \
